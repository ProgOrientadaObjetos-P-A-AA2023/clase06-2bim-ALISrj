...
public class Enlace {
    ...
    private ArrayList<Ciudad> listaDataCiudad = new ArrayList<>();
    ...
    public void establecerListaDataCiudad() {
        try {
            establecerConexion();
            Statement statement = obtenerConexion().createStatement();
    ...
    public ArrayList<Ciudad> obtenerListaDataCiudad() {
        return listaDataCiudad;
    }
